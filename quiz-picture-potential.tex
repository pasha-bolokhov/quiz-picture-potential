...
\begin{tikzpicture}
	...
	\def\posrad{0.3}
	\shade [draw=none, ball color=\poscolor, name path=pos-charge]
	...
	\filldraw (A) [draw=none, fill=black, name path=point-A]
		circle (\ptrad) node [above, left, xshift=-3mm, yshift=3mm] { A };

	%
	% Distances
	%
	\path [draw=none, name path=distance-pos-A]
		(-\chgdist, 0) -- (A);
	\path [draw=none, name path=distance-neg-A]
		(\chgdist, 0) -- (A);
	\draw [thick, draw=blue, style={Stealth[length=2.0mm]}-{Stealth[length=2.0mm]}, dash pattern=on 7pt off 2pt,
		name intersections={of=distance-pos-A and pos-charge, name=pos-connect},
		name intersections={of=distance-pos-A and point-A, name=point-A-pos-connect}]
		(pos-connect-1) -- (point-A-pos-connect-1)
		node [xshift=-3mm, midway, color=blue, rotate=90] {$ 40\,\text{cm} $};
	\draw [thick, draw=blue, style={Stealth[length=2.0mm]}-{Stealth[length=2.0mm]}, dash pattern=on 7pt off 2pt,
		name intersections={of=distance-neg-A and neg-charge, name=neg-connect},
		name intersections={of=distance-neg-A and point-A, name=point-A-neg-connect}]
		(neg-connect-1) -- (point-A-neg-connect-1)
		node [pos=0.7, above, color=blue, rotate={-atan(0.5)}] {$ 80\,\text{cm} $};
\end{tikzpicture}
